                ...
                <div className="grid md:grid-cols-12 grid-cols-1 mt-6 gap-6">
                        ...
                        <div className="sticky top-20">
                            <ul className="flex-column p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                <li role="presentation">
                                    <button onClick={()=>setActiveTab(1)} className={`px-4 py-2 text-start text-base font-medium rounded-md w-full hover:text-teal-500 duration-500 ${activeTab === 1 ? 'text-white bg-teal-500 hover:text-white' : ''}`}>
                                ...
                                <li role="presentation">
                                    <button onClick={()=>setActiveTab(2)} className={`px-4 py-2 my-6 text-start text-base font-medium rounded-md w-full hover:text-teal-500 duration-500 ${activeTab === 2 ? 'text-white bg-teal-500 hover:text-white' : ''}`}>
                                ...
                                <li role="presentation">
                                    <button onClick={()=>setActiveTab(3)} className={`px-4 py-2 text-start text-base font-medium rounded-md w-full hover:text-teal-500 duration-500 ${activeTab === 3 ? 'text-white bg-teal-500 hover:text-white' : ''}`}>
                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        <div id="myTabContent" className="p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md">
                            {activeTab === 1 && 
                                <div className="">
                                    <img src={blog1} className="shadow-sm dark:shadow-gray-700 rounded-md" alt=""/>
                                    <div className="mt-6">
                            ...
                            }
                            {
                                activeTab === 2 &&
                                <div>
                                    <img src={blog2} className="shadow-sm dark:shadow-gray-700 rounded-md" alt=""/>
                                    <div className="mt-6">
                            ...
                            }
                            {
                                activeTab === 3 &&
                                <div>
                                    <img src={blog3} className="shadow-sm dark:shadow-gray-700 rounded-md" alt=""/>
                                    <div className="mt-6">
