                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                    ...
                    <div className="md:col-span-6">
                        <div className="lg:ms-8">
                            ...
                            <h3 className="font-semibold text-2xl leading-normal mb-4">We're Talent agency that connects talents with clients who are facing unexpected personal or professional </h3>
